...
function addGamesToPage(games) {
    ...
    for ( let i = 0; i < games.length; i++){
        ...
        gameCard.innerHTML = `
            ...
            &nbsp;&nbsp;
            <h2>${game.name}</h2>
            <p>${game.description} <br><br> Pledged: ${game.backers}</p>
            `;
...
const description = `A total of ${totalRaised.toLocaleString()} has been raised for ${totalGames.toLocaleString()} games. Currently, ${unfundedGames.toLocaleString()} game reamins unfunded. We need your help to fund these amazing games!`;
